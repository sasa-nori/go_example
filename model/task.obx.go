...
func (task_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Task", 1, 6463212522205470931)
	model.Property("Id", 6, 1, 8795887226587457556)
	model.PropertyFlags(8193)
	model.Property("Text", 9, 2, 1576131752894198636)
	model.Property("DateCreated", 6, 3, 3229026114223128317)
	model.Property("DateFinished", 6, 4, 1048885026410962901)
	model.EntityLastPropertyId(4, 1048885026410962901)
}
